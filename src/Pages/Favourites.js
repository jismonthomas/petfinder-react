        ...
        <div className='mt-16 px-4 md:px-16 lg:px-24'>
            ...
            {!userLoggedIn &&
                <div className="text-center rounded-sm bg-white shadow-lg p-5 w-[450px] max-w-[80%] mx-auto text-slate-700 border-2 border-orange-400">
                    <h1 className="font-semibold text-[2rem] mb-5">Please Login To Continue</h1>
                    <button className="rounded py-2 shadow-sm px-3 my-4 bg-orange-400 text-white" onClick={toggleLoginPopup}>
                        Login Now
                    </button>
                </div>
            }
