...
function PetDetails() {
    ...
    return (<Fragment>
        ...
        <div className='mt-16 px-10 md:px-16 lg:px-24'>
            ...
            <div className='bg-white rounded-lg flex flex-col lg:flex-row p-10'>
                {isLoading &&
                ...
                {!isLoading &&
                    <>
                        <div className='rounded-lg'>
                            {result?.animal.primary_photo_cropped.medium && <img src={result.animal.primary_photo_cropped.medium} className='max-w-[320px] rounded-lg' />}
                        </div>
                        <div className='ml-10'>
                            <div className='flex flex-col justify-between h-full'>
                                <div>
                                    ...
                                    <div className='flex mb-7 mt-5'>
                                        ...
                                        {result?.animal.age &&
                                            <span className='bg-green-200 font-medium text-green-700 text-sm px-3 py-1 rounded-sm ml-4'>{result?.animal.age}</span>
                                        }
                                        {result?.animal.gender &&
                                            <span className='bg-orange-200 font-medium text-orange-700 text-sm px-3 py-1 rounded-sm ml-4'>{result?.animal.gender}</span>
                                        }
                                        {result?.animal.size &&
                                            <span className='bg-purple-200 font-medium text-purple-700 text-sm px-3 py-1 rounded-sm ml-4'>{result?.animal.size} Size</span>
                                        }
                                    </div>
